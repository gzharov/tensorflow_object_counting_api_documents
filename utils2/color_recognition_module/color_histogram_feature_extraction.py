...
from utils2.color_recognition_module import knn_classifier as knn_classifier
...
def color_histogram_of_test_image(test_src_image):
	...
	with open(current_path+"/utils2/color_recognition_module/"+"test.data", "w") as myfile:						
