from utils2.color_recognition_module import color_histogram_feature_extraction
from utils2.color_recognition_module import knn_classifier
import os
from utils2.image_utils import crop_image
...
def color_recognition(crop_img):
  ...
  open(current_path+"/utils2/color_recognition_module/"+"test.data", "w")   
  color_histogram_feature_extraction.color_histogram_of_test_image(crop_img) # send image piece to regonize vehicle color
  prediction = knn_classifier.main(current_path + "/utils2/color_recognition_module/" + "training.data", current_path + "/utils2/color_recognition_module/" + "test.data")
